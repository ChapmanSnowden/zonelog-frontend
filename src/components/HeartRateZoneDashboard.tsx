...
interface HeartRateZoneDashboardProps {
  minimal?: boolean;
}

export const HeartRateZoneDashboard: React.FC<HeartRateZoneDashboardProps> = ({ minimal = false }) => {
  ...
  const handleConnectStrava = () => {
    const authUrl = `${process.env.REACT_APP_API_URL}/api/auth/strava`;
...
// Add an empty export to make it a proper module
export {};